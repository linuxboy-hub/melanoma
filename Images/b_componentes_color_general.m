function [y,s]=b_componentes_color_general(a);
...
%         'srgb2lab'  'lab2srgb'  'srgb2cmyk'   'cmyk2srgb'
    ...
    a8=rgb2hsv(a);                  % convertir rgb a hsv
    a88=a8;total=a8(:,:,2);
    ...
    figure(2); imshow([a1,a2;a6,a7;a4,a5;a8,a9]);
    title(['lab-xyz  cmy-k  lch-uvl  hsv-rgb']);
    pause;
    
%     h1=a444(:,:,3);h1n=255-h1;
%     h2=a888(:,:,1);h2n=255-h2;
%     figure; imshow([h1,h2;h1n,h2n]);impixelinfo;pause
